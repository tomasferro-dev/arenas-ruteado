...
//           <h2 className="text-4xl mb-4 text-gray-900">¿Por Qué Elegir Arenas Perforaciones?</h2>
...
//             <img src={ArenasImg} className="rounded-lg shadow-xl w-full h-[500px] object-cover object-[center_40%]" />
//           </div>
