...
// // import HeroImageDesktop from '../../assets/hero3.jpg';
...
//           <motion.div
//             variants={item}
//             className="inline-flex items-center gap-2 bg-red-700/20 border border-red-700/30 text-red-300 text-sm px-4 py-1.5 rounded-full mb-6"
//           >
//             <span className="w-2 h-2 rounded-full bg-red-400 animate-pulse" />
//             Región de Cuyo y Argentina · Más de 20 años de experiencia
//           </motion.div>
...
//           >
//             Perforación de Pozos de Agua en{' '}
//             <span className="text-red-400">Mendoza y San Juan</span>
//           </motion.h1>
...
//           >
//             Empresa especializada en pozos profundos para uso{' '}
//             <strong className="text-white">
//               rural, residencial e industrial
//             </strong>
//             . Electrobombas, bobinados, filmaciones y más.
//           </motion.h2>
...
//           >
//             {[
//               'Perforaciones certificadas',
//               'Más de 20 años de experiencia',
//               'Presupuesto y asesoramiento sin cargo',
//             ].map((f) => (
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <motion.h2
            ...
            className="text-base sm:text-xl text-gray-300 mb-8 max-w-2xl"
          >
            Empresa nacional especializada en pozos profundos para uso{' '}
            <strong className="text-white">
              rural, residencial e industrial
            </strong>
