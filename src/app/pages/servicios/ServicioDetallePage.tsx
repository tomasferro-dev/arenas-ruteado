  ...
  return (
    <>
      ...
      {/* <div className={`bg-gradient-to-br ${service.gradient} text-white`}>
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <div className="flex items-start gap-6 max-w-3xl">
            ...
            <div>
              <h1 className="text-4xl sm:text-5xl font-semibold mb-4">{service.title}</h1>
              <p className="text-white/90 text-lg leading-relaxed">{service.shortDescription}</p>
            </div>
          </div>
        </div>
      </div> */}
      ...
      <div className="relative text-white">
        {/* Imagen de fondo */}
        <img
          src={service.images[1] || service.image}
          alt={service.title}
          ...
          <div className="space-y-6">
            ...
            <div className="bg-red-50 border border-red-100 rounded-xl p-5">
              ...
              <p className="text-red-700 text-sm">
                Mendoza y San Juan — toda la provincia.
              </p>
            </div>
          </div>
        </div>
